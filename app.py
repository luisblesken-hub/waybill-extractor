...
.hero { background: linear-gradient(135deg,#0f2027,#203a43,#2c5364); padding:2.5rem 2rem; border-radius:16px; color:white; margin-bottom:2rem; }
.hero h1 { margin:0; font-size:2.2rem; font-weight:800; }
.hero p  { margin:0.5rem 0 0; opacity:0.8; font-size:1.1rem; }

.stat-box { background:white; border:1px solid #e5e7eb; border-radius:12px; padding:1.2rem; text-align:center; }
...
.credit-box { background:linear-gradient(135deg,#1d4ed8,#2563eb); border-radius:12px; padding:1.5rem; color:white; text-align:center; }
...
.quality-bar { height:8px; border-radius:4px; background:#e5e7eb; overflow:hidden; }
.quality-fill { height:100%; border-radius:4px; background:linear-gradient(90deg,#3b82f6,#10b981); }
